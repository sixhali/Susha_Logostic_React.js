  ...
  return (
    <div className='supportspage-container'>
        ...
        <div className='supportspage-boxs'>
          <div className='supportspage-box supportspage-box_1'>
          ...
          <div className='supportspage-box supportspage-box_3 relative bottom-20 '>
            <img src={Supportspage1} alt="" />
            <div className='supportspage-boxText'>
             <h4>Hava yol daşımacılığı</h4>
             <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
          ...
          <div className='supportspage-box supportspage-box_4 supportspage-box relative bottom-32'>
            <img src={Supportspage1} alt="" />
            <div className='supportspage-boxText'>
             <h4>Hava yol daşımacılığı</h4>
             <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
          ...
          <div className='supportspage-box supportspage-box_5 relative bottom-10 left-80 '>
            <img src={Supportspage1} alt="" />
            <div className='supportspage-boxText'>
             <h4>Hava yol daşımacılığı</h4>
             <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
          ...
          <div className='supportspage-box supportspage-box_6 relative bottom-20 left-80'>
            <img src={Supportspage1} alt="" />
            <div className='supportspage-boxText'>
             <h4>Hava yol daşımacılığı</h4>
             <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
          ...
          <div className='supportspage-box supportspage-box_7 relative  bottom-32 left-80'>
            <img src={Supportspage1} alt="" />
            <div className='supportspage-boxText'>
             <h4>Hava yol daşımacılığı</h4>
             <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
